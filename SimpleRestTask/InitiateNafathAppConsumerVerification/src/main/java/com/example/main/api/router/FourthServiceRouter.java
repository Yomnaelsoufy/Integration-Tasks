    ...
    public void configure() throws Exception {
        ...
        from("direct:fourthService").doTry()
                ...
                .process(exchange -> {
                    ...
                    // HeaderMapper headerMapper = // Inject or create an instance of the generated
                    // mapper
        ...
        // "INSERT INTO nafathInfo (id, poinum, poitype, mobilenum) VALUES
        // (1,'${header.IDNumber}', '${header.IDType}', '${header.mobileNumber}')"))
        // .log("{$body}").to("jdbc:myDataSource").log("Data inserted successfully into
        // nafathtable")
        // .setBody(constant("{\"id\": \"1081871111\", \"action\": \"SpRequest\",
        // \"service\":\"Login\" }"))
        // .log("fourth req: ${body}").setHeader(Exchange.HTTP_METHOD, constant("POST"))
        // .to("http://localhost:8086/v1/nafath-app/id-verification/initiate?bridgeEndpoint=true");
